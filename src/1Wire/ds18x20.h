...
uint8_t czujniki_cnt;						///< iloœc czujników na magistrali
uint8_t subzero, cel, cel_fract_bits;		///< zmienne przechowuj¹ce znak oraz wartoœci dziesiêtne i u³amkowe temperatury
