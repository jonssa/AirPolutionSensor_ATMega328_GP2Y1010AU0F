...
/*!
 * tablice znakÛw do wyúwietlenia na wyúwietlaczu LCD
 */
extern uint8_t znak_happy[];		///< wzÛr miny uúmiechniÍtej
extern uint8_t znak_neutral[];		///< wzÛr miny neutralnej
extern uint8_t znak_sad[];			///< wzÛr miny smutnej
extern uint8_t znak_3[];			///< wzÛr znaku 3 w indeksie gÛrnym
extern uint8_t znak_termo[];	///< wzÛr znaku termometru
